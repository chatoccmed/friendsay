...
export const airConditionerShopeeProofs: AirConditionerShopeeProof[] = [
  ...
  {
    queueRank: 32,
    productKey: "haier-vqec-series",
    reviewSlug: "haier-vqec-inverter-air-conditioner",
    brand: "HAIER",
    modelOrSeries: "HSU-VQEC05 (VQEC Series Inverter)",
    status: "detail_verified",
    productUrl: "https://shopee.co.th/product/184920733/29154242468",
    affiliateUrl: "https://s.shopee.co.th/LlLAiiBoB",
    searchQuery: "แอร์ Haier VQEC inverter",
    visiblePrice: 9545,
    visibleRating: 4.9,
    ratingsCount: 3000,
    commentsCount: 678,
    ...
    reviewThemeSource: "shopee_detail_2026-07-02",
    nextAction: "write_full_review",
    notes: "haier.officialshop (836k followers, same shop as CANDY). Sold 8k+ visible. Warranty: unit 5y, compressor 10y. SEER per size on page: 09=18.29, 12=18.97, 18=18.73, 24=18.08 - source for energy calculator. Watch-outs: no wall bracket in box, claims require unboxing video, one review says 18000 BTU compressor is large and noisy.",
    lastChecked: "2026-07-02"
  },
  {
    queueRank: 33,
    productKey: "hisense-ce-series",
    reviewSlug: "hisense-ce-inverter-air-conditioner",
    brand: "HISENSE",
    modelOrSeries: "CE Series Inverter (AS10TRCE2T)",
    status: "detail_verified",
    productUrl: "https://shopee.co.th/product/54473054/25171357270",
    affiliateUrl: "https://s.shopee.co.th/3g1n8tmR7w",
    searchQuery: "Hisense แอร์ติดผนัง CE Series",
    visiblePrice: 8452,
    visibleRating: 4.8,
    ratingsCount: 4700,
    commentsCount: 1000,
    ...
    reviewThemeSource: "shopee_detail_2026-07-02",
    nextAction: "write_full_review",
    notes: "Hisense Official Store - Shopee Mall (1.8m followers, 278.8k shop rating). Sold 10k+ visible. Warranty: unit 3y + compressor 12y + onsite service, Thai service center 020170077. Cheapest verified inverter (8452). Watch-outs: swing up-down only (no left-right), install discount 50% via Q-CHANG per reviews. Shop also sells portable AC AP-12CR4RNXS0 at 7110 - portable queue candidate.",
    lastChecked: "2026-07-02"
  },
  {
    queueRank: 31,
