...
- [ ] 1. ซ่อม "ของสู้หน้าฝน" ให้ผ่าน Gate เต็ม: ภาพจริง 7 ตัว + ตารางเทียบ + กราฟแท่งราคา×ยอดขาย + quick-pick + hero มีภาพ
- [ ] 2. สร้างหน้าแรกใหม่ 6 ช่วง: hero ตัวเลขจริง / showcase แอร์ (โพเดียมย่อ + BTU ฝัง) / ตามฤดูตอนนี้ / เครื่องมือ / เราทำงานยังไง / บทความล่าสุด — แก้ลิงก์วน #product-worlds, ถอดลิงก์หน้า sample, หมวด roadmap ติดป้าย "เร็ว ๆ นี้", เมนูใหม่ (แอร์นำ + เพิ่มเครื่องมือ/ตามฤดู)
