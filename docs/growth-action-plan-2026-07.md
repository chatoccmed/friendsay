...
- [x] 7a. เครื่องมือแรกเสร็จ (2026-07-02): คู่มือ BTU + เครื่องคิดเลข ที่ /th/guides/btu-calculator/ (AC-G01+T01) — ลิงก์จากหน้าจัดอันดับแล้ว
- [ ] 7b. เริ่มช่องทางกระจาย 1 ช่องทาง (แนะนำ Facebook Page — มีเพจ facebook.com/friendsay เดิมอยู่แล้ว)

สถานะแผนแม่บทแอร์ (2026-07-02): เฟส 1 คืบหน้า — AC-R01 (จัดอันดับ 10 รุ่น + ตารางเทียบ + scenario picker + FAQ) เสร็จ, AC-G01+T01 (BTU) เสร็จ · คิวถัดไป: AC-G02 (ค่าติดตั้งจริง — วัตถุดิบครบแล้วจาก Panasonic/Daikin), AC-G03+T02 (SEER/ค่าไฟ — มีข้อมูล SEER Haier ทุกขนาด + ฉลากเบอร์ 5 Hisense), AC-R02 (ประหยัดไฟ)
